...
print("After adding the fisher data, the lexicon contains {} entries".format(
    len(merged_lexicon)))
...
print("After adding the LDC data, the lexicon contains {} entries".format(
    len(merged_lexicon)))
...
print("After adding the Gigaword data, the lexicon contains {} entries".format(
    len(merged_lexicon)))
