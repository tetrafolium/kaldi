...
decode_directories = [
    'exp/tri5a/decode_dev', 'exp/tri5a/decode_test', 'exp/tri5a/decode_dev2',
    'exp/sgmm2x_6a/decode_dev_fmllr', 'exp/sgmm2x_6a/decode_test_fmllr',
    'exp/sgmm2x_6a/decode_dev2_fmllr', 'exp/sgmm2x_6a_mmi_b0.2/decode_dev_it1',
...
def get_best_wer(decode_dir):
    ...
    for i in range(16):
        if os.path.isfile("{}/wer_{}".format(decode_dir, i)):
            result = subprocess.check_output("tail -n 3 {}/wer_{}".format(
                decode_dir, i),
                                             shell=True)
