...
parser.add_option('--hid-bias-mean',
                  dest='hid_bias_mean',
...
parser.add_option(
    ...
    action='store_true',
    default=False)
parser.add_option('--dropout-opts',
                  dest='dropout_opts',
        ...
        print(
            ...
            % (o.bottleneck_dim, num_hid_neurons, o.hid_bias_mean,
               ...
               (o.param_stddev_factor *
                Glorot(o.bottleneck_dim, num_hid_neurons)), o.max_norm))
    ...
    if o.bottleneck_trick:
        ...
        print(
            ...
            % (num_hid_neurons, o.bottleneck_dim,
               (o.param_stddev_factor *
                Glorot(num_hid_neurons, o.bottleneck_dim) * 0.75), 0.1))
        # 25% smaller stddev -> smaller gradient in prev. layer, 10x smaller learning rate for weigts & biases
        print(
            ...
            (o.bottleneck_dim, num_hid_neurons, o.hid_bias_mean,
             o.hid_bias_range,
             (o.param_stddev_factor * Glorot(o.bottleneck_dim, num_hid_neurons)
              * 0.75), 0.1, 0.1, o.max_norm, o.affine_opts))
    else:
        ...
        print(
            "<AffineTransform> <InputDim> %d <OutputDim> %d <BiasMean> %f <BiasRange> %f <ParamStddev> %f <MaxNorm> %f %s"
            % (o.bottleneck_dim, num_hid_neurons, o.hid_bias_mean,
               o.hid_bias_range, (o.param_stddev_factor *
