...
parser.add_option(
    ...
    dest='splice_step',
    help=
    'splicing step (frames dont need to be consecutive, --splice 3 --splice-step 2 will select offsets: -6 -4 -2 0 2 4 6)',
    default='1')
...
splice_vec = list(
    range(-splice * splice_step, splice * splice_step + 1, splice_step))
