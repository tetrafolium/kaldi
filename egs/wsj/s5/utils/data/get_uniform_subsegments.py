...
def run(args):
    ...
    for line in args.segments_file:
        ...
        print("{new_utt} {utt_id} {s:.3f} {e:.3f}".format(new_utt=new_utt,
                                                          utt_id=utt_id,
                                                          s=start - start_time,
                                                          e=end - start_time))
