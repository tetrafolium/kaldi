                ...
                while True:
                    ...
                    try:
                        ...
                        backoff_prob = math.exp(
                            float(a[cur_order+1]) * log10) if l == cur_order + 2 else None
                    ...
                    if backoff_prob != None:
                        self.orders[cur_order][hist +
                                               (word,)].backoff_prob = backoff_prob
    ...
    def PrintAsFst(self, disambig_symbol, bigram_map):
        ...
        for state in range(len(state_to_hist)):
            ...
            if hist_len == 1:  # it's a bigram state...
                ...
                backoff_hist = hist[1:]
                backoff_state = self.GetStateForHist(
                    hist_to_state, backoff_hist)
