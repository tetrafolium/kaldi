...
def get_args():
    ...
    parser.add_argument("--num-neighbors-to-search",
                        type=int,
                        default=0,
    ...
    parser.add_argument("--neighbor-tfidf-threshold",
                        type=float,
                        default=0.9,
    ...
    parser.add_argument("--partial-doc-fraction",
                        default=0.2,
    ...
    parser.add_argument("--query-tfidf",
                        ...
                        """)
    parser.add_argument("--relevant-docs",
...
def get_document_ids(source_docs, indexes):
    indexes = sorted([(key, value[0], value[1])
