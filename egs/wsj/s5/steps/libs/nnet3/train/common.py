    ...
    try:
        ...
        try:
            egs_left_context_initial = int(
                open('{0}/info/left_context_initial'.format(egs_dir)).
                readline())
        ...
        if (egs_left_context < left_context
            ...
            raise Exception(
                ...
                'versus expected ({2},{3})'.format(
                    egs_left_context, egs_right_context, left_context,
                    right_context))
...
def get_learning_rate(iter, num_jobs, num_iters, num_archives_processed,
    ...
    if iter + 1 >= num_iters:
        ...
        effective_learning_rate = (initial_effective_lrate * math.exp(
            num_archives_processed * math.log(
                float(final_effective_lrate) / initial_effective_lrate) /
