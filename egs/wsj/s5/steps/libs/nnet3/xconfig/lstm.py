...
class XconfigLstmLayer(XconfigLayerBase):
    ...
    def _generate_lstm_config(self):
        ...
        recurrence_scale = (1.0 if decay_time < 0 else 1.0 -
                            (abs(delay) / decay_time))
        ...
        repair_nonlin_str = "self-repair-scale={0:.10f}".format(
            repair_nonlin) if repair_nonlin is not None else ''
        ...
        configs.append(
            ...
            "output-dim={2} {3} {4}".format(name, input_dim + cell_dim,
                                            cell_dim, affine_str,
        ...
        configs.append(
            "component-node name={0}.c_t component={0}.c input=Sum({0}.c1_t, {0}.c2_t)"
            .format(name))
        delayed_c_t_descriptor = "IfDefined(Offset({0}.c_t, {1}))".format(
            name, delay)
        ...
        configs.append(
            "component-node name={0}.i2_t component={0}.w_i.c  input={1}".
            format(name, delayed_c_t_descriptor))
        configs.append(
            "component-node name={0}.i_t component={0}.i input=Sum({0}.i1_t, {0}.i2_t)"
            .format(name))
        ...
        configs.append(
            ...
            "".format(name, input_descriptor, delay))
        configs.append(
            "component-node name={0}.f2_t component={0}.w_f.c  input={1}".
            format(name, delayed_c_t_descriptor))
        configs.append(
            "component-node name={0}.f_t component={0}.f input=Sum({0}.f1_t, {0}.f2_t)"
            .format(name))
        ...
        configs.append(
            ...
            "".format(name, input_descriptor, delay))
        configs.append(
            "component-node name={0}.o2_t component={0}.w_o.c input={0}.c_t".
            format(name))
        configs.append(
            "component-node name={0}.o_t component={0}.o input=Sum({0}.o1_t, {0}.o2_t)"
            .format(name))

        configs.append("# h_t")
        configs.append(
            "component-node name={0}.h_t component={0}.h input={0}.c_t".format(
                name))
        ...
        configs.append(
            ...
            "".format(name, input_descriptor, delay))
        configs.append(
            "component-node name={0}.g_t component={0}.g input={0}.g1_t".
            format(name))
        ...
        configs.append(
            ...
            "".format(name, cell_dim, bptrunc_str))
        configs.append(
            "component-node name={0}.r_t component={0}.r input={0}.m_t".format(
                name))
...
class XconfigLstmpLayer(XconfigLayerBase):
    ...
    def output_name(self, auxiliary_output=None):
        node_name = ('rp_t_batchnorm'
                     if self.layer_type == 'lstmp-batchnorm-layer' else 'rp_t')
        if auxiliary_output is not None:
            if auxiliary_output in self.auxiliary_outputs():
                node_name = auxiliary_output
            else:
    ...
    def _generate_lstm_config(self):
        ...
        if dropout_proportion != -1.0:
            configs.append(
                "component-node name={0}.i_t_predrop component={0}.i input=Sum({0}.i1_t, {0}.i2_t)"
                .format(name))
            configs.append(
                "component-node name={0}.i_t component={0}.dropout input={0}.i_t_predrop"
                .format(name))
        else:
            configs.append(
                "component-node name={0}.i_t component={0}.i input=Sum({0}.i1_t, {0}.i2_t)"
        ...
        if dropout_proportion != -1.0:
            configs.append(
                "component-node name={0}.f_t_predrop component={0}.f input=Sum({0}.f1_t, {0}.f2_t)"
                .format(name))
            configs.append(
                "component-node name={0}.f_t component={0}.dropout input={0}.f_t_predrop"
                .format(name))
        else:
            configs.append(
                "component-node name={0}.f_t component={0}.f input=Sum({0}.f1_t, {0}.f2_t)"
        ...
        configs.append("# o_t")
        configs.append(
            "component-node name={0}.o1_t component={0}.W_o.xr input=Append({1}, IfDefined(Offset({2}, {3})))"
            .format(name, input_descriptor, recurrent_connection, delay))
        configs.append(
            "component-node name={0}.o2_t component={0}.w_o.c input={0}.c_t".
            format(name))
        if dropout_proportion != -1.0:
            configs.append(
                "component-node name={0}.o_t_predrop component={0}.o input=Sum({0}.o1_t, {0}.o2_t)"
                .format(name))
            configs.append(
        ...
        configs.append(
            ...
            "output-dim={2} {3} {4}".format(name, cell_dim,
        ...
        configs.append(
            "component-node name={0}.r_t component={0}.r input={0}.r_t_preclip"
            .format(name))

        if self.layer_type == "lstmp-batchnorm-layer":
            # Add the batchnorm component, if requested to include batchnorm.
            configs.append(
                "component name={0}.rp_t_batchnorm type=BatchNormComponent dim={1} "
...
class XconfigFastLstmLayer(XconfigLayerBase):
    ...
    def set_default_configs(self):
        ...
        # keep track of whether the 'c' output is needed.
        self.c_needed = False
    ...
    def output_name(self, auxiliary_output=None):
        node_name = ('m_batchnorm' if
                     self.layer_type == 'fast-lstm-batchnorm-layer' else 'm')
        if auxiliary_output is not None:
    ...
    def _generate_lstm_config(self):
        ...
        configs.append(
            "dim-range-node name={0}.m input-node={0}.lstm_nonlin dim-offset={1} dim={1}"
            .format(name, cell_dim))
        configs.append(
            "component-node name={0}.cm_trunc component={0}.cm_trunc input={0}.lstm_nonlin"
            .format(name))
        configs.append(
            "dim-range-node name={0}.c_trunc input-node={0}.cm_trunc dim-offset=0 dim={1}"
            .format(name, cell_dim))
        configs.append(
            "dim-range-node name={0}.m_trunc input-node={0}.cm_trunc dim-offset={1} dim={1}"
            .format(name, cell_dim))

        if self.layer_type == "fast-lstm-batchnorm-layer":
            # Add the batchnorm component, if requested to include batchnorm.
            configs.append(
                "component name={0}.m_batchnorm type=BatchNormComponent dim={1} "
                .format(name, cell_dim))
            configs.append(
    ...
    def _generate_lstm_config(self):
        ...
        configs.append(
            ...
            "orthonormal-constraint={2} output-dim={3} {4}".format(
                ...
                self.config['orthonormal-constraint'], bottleneck_dim,
                affine_str))
        ...
        configs.append(
            "component name={0}.cm_trunc type=BackpropTruncationComponent dim={1} {2}"
            .format(name, 2 * cell_dim, bptrunc_str))
        configs.append(
            "component name={0}.m_batchnorm type=BatchNormComponent dim={1} ".
            format(name, cell_dim))
        ...
        configs.append(
            "component-node name={0}.lstm_nonlin component={0}.lstm_nonlin "
            "input=Append({0}.W_all_b_so, IfDefined(Offset({0}.c_trunc, {1})))"
            .format(name, delay))
        configs.append(
...
class XconfigFastLstmpLayer(XconfigLayerBase):
    def __init__(self, first_token, key_to_value, prev_names=None):
        assert first_token in [
            'fast-lstmp-layer', 'fast-lstmp-batchnorm-layer'
        ]
        XconfigLayerBase.__init__(self, first_token, key_to_value, prev_names)
    ...
    def output_name(self, auxiliary_output=None):
        node_name = ('rp_batchnorm' if
                     self.layer_type == 'fast-lstmp-batchnorm-layer' else 'rp')
        if auxiliary_output is not None:
            if auxiliary_output in self.auxiliary_outputs():
                node_name = auxiliary_output
            else:
    ...
    def _generate_lstm_config(self):
        ...
        configs.append(
            ...
            "use-dropout={2} {3} {4}".format(
                name, cell_dim,
                "true" if dropout_proportion != -1.0 else "false", lstm_str,
                l2_regularize_option))
        configs.append(
            "# Component for backprop truncation, to avoid gradient blowup in long training examples."
        )
        ...
        configs.append(
            "component-node name={0}.W_all component={0}.W_all input=Append({1}, "
            "IfDefined(Offset({0}.r_trunc, {2})))".format(
                name, input_descriptor, delay))
        ...
        configs.append(
            "component-node name={0}.rp component={0}.W_rp input={0}.m".format(
                name))
        configs.append(
        ...
        if self.layer_type == "fast-lstmp-batchnorm-layer":
            # Add the batchnorm component, if requested to include batchnorm.
            configs.append(
                "component name={0}.rp_batchnorm type=BatchNormComponent dim={1} "
                .format(name, rec_proj_dim + nonrec_proj_dim))
            configs.append(
