...
def CheckArgs(args):
    ...
    args.lexicon_phonetic_decoding_handle = open(
        args.lexicon_phonetic_decoding)
...
def Main():
    ...
    lexicon_phonetic_decoding = ReadLexicon(
        args.lexicon_phonetic_decoding_handle)
    lexicon_g2p, lexicon_g2p_probs = ReadLexiconp(args.lexiconp_g2p_handle)
    stats = ReadStats(args.pron_stats_handle)

    PruneProns(args, stats, ref_lexicon, lexicon_phonetic_decoding,
               lexicon_g2p, lexicon_g2p_probs)
