...
def WriteEditsAndSummary(args, learned_lexicon, ref_lexicon, pd_lexicon, g2p_lexicon, counts, stats, stats_summed):
    ...
    for word, count in words_to_edit_sorted:
        ...
        for item in learned_prons_sorted:
            print('{} | {} |  {:.2f} | {}'.format(
                item[0], item[1], item[2], item[3]), file=args.ref_lexicon_edits_handle)
    ...
    print("We have acoustic evidence for {} out of {} in-vocab (w.r.t the reference lexicon) words from the acoustic training data.".format(
    ...
    print('We have acoustic evidence for {} out of {} OOV (w.r.t the reference lexicon) words from the acoustic training data.'.format(
...
def Main():
    ...
    WriteEditsAndSummary(args, learned_lexicon, ref_lexicon,
                         pd_lexicon, g2p_lexicon, counts, stats, stats_summed)
