...
def SelectPronsBayesian(args, counts, posteriors, ref_lexicon, g2p_lexicon,
    ...
    print(
        ...
        file=sys.stderr)
    print(
        'Num. words in the learned lexicon: {0} num. selected prons: {1}'.
...
def WriteEditsAndSummary(args, learned_lexicon, ref_lexicon,
    ...
    print(
        ...
        file=args.ref_lexicon_edits_handle)
    print(
        "# 4th Col: the pronunciation cadidate.",
        file=args.ref_lexicon_edits_handle)
    ...
    print(
        ...
        file=sys.stderr)
    print(
        ' {} words\' selected prons came from the reference lexicon only.'.
        format(num_freq_ivs_from_ref),
        file=sys.stderr)
    print(
        '  For those words whose counts in the training text <= {}:'.format(
            threshold),
        file=sys.stderr)
    print(
        ' {} words\' selected prons came from the reference lexicon, G2P/phonetic-decoding.'
    ...
    print(
        ...
        file=sys.stderr)
    print(
        '    {} words\' selected prons came from G2P and phonetic-decoding.'.
        format(num_freq_oovs_from_both_sources),
        file=sys.stderr)
    print(
        '    {} words\' selected prons came from phonetic decoding only.'.
