...
def get_args():
    ...
    parser.add_argument("--transition-scale",
                        type=float,
                        default=1.0,
                        help="""Scale on transition probabilities relative to
                        LM weights""")
    parser.add_argument("--loopscale",
                        type=float,
                        default=0.1,
                        help="""Scale on self-loop log-probabilities relative
                        to LM weights""")

    parser.add_argument("--min-silence-duration",
                        type=float,
                        default=0.03,
                        help="""Minimum duration for silence""")
    parser.add_argument("--min-speech-duration",
                        type=float,
                        default=0.3,
                        help="""Minimum duration for speech""")
    parser.add_argument("--max-speech-duration",
                        type=float,
                        default=10.0,
    ...
    parser.add_argument("--edge-silence-probability",
                        type=float,
                        default=0.5,
                        help="Probability of silence at the edges.")
    parser.add_argument("--transition-probability",
                        type=float,
                        default=0.1,
    ...
    args.min_states_silence = int(args.min_silence_duration /
...
def print_states(args, file_handle):
    ...
    print("0 1 silence silence {0}".format(
        -math.log(args.edge_silence_probability)),
          file=file_handle)
