...
### main ###
radical = ['日', '月', '金', '木', '水', '火', '土', '竹', '戈', '十', '大',
           '中', '一', '弓', '人', '心', '手', '口', '尸', '廿', '山', '女', '田', '卜']
lex = {}
...
with open(text_path, 'r', encoding='utf-8') as f:
    for line in f:
        ...
        for i in range(1, len(line_vect)):
            ...
            characters = " ".join(['SIL' if char == '|' else char if char in radical else cj5_table[char]
                                   if char in cj5_table else char for char in characters])
