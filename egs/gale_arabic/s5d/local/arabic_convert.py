...
def get_unicode_dict():
    unicode_dict = {}
    utf8_list = [("621", "'"), ("622", "|"), ("623", ">"), ("624", "&"),
                 ("625", "<"), ("626", "}"), ("627", "A"), ("628", "b"),
                 ("629", "p"), ("62A", "t"), ("62B", "v"), ("62C", "j"),
                 ("62D", "H"), ("62E", "x"), ("62F", "d"), ("630", "*"),
                 ("631", "r"), ("632", "z"), ("633", "s"), ("634", "$"),
                 ("635", "S"), ("636", "D"), ("637", "T"), ("638", "Z"),
                 ("639", "E"), ("63A", "g"), ("640", "_"), ("641", "f"),
                 ("642", "q"), ("643", "k"), ("644", "l"), ("645", "m"),
                 ("646", "n"), ("647", "h"), ("648", "w"), ("649", "Y"),
                 ("64A", "y"), ("64B", "F"), ("64C", "N"), ("64D", "K"),
                 ("64E", "a"), ("64F", "u"), ("650", "i"), ("651", "~"),
                 ("652", "o"), ("670", "`"), ("671", "{"), ("67E", "P"),
                 ("686", "J"), ("6A4", "V"), ("6AF", "G")]
